...
export interface ApiConfiguracionTiendaConfiguracionTienda
  extends Struct.CollectionTypeSchema {
  collectionName: 'configuracion_tiendas';
  info: {
    singularName: 'configuracion-tienda';
    pluralName: 'configuracion-tiendas';
    displayName: 'configuracion_tienda';
  };
  options: {
    draftAndPublish: true;
  };
  attributes: {
    terminos_condiciones: Schema.Attribute.Text;
    politica_devoluciones: Schema.Attribute.Text;
    coste_peninsula: Schema.Attribute.Decimal;
    coste_canarias: Schema.Attribute.Decimal;
    createdAt: Schema.Attribute.DateTime;
    updatedAt: Schema.Attribute.DateTime;
    publishedAt: Schema.Attribute.DateTime;
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
    ...
    localizations: Schema.Attribute.Relation<
      'oneToMany',
      'api::configuracion-tienda.configuracion-tienda'
    > &
      Schema.Attribute.Private;
  };
}
...
export interface ApiDireccionDireccion extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    clientes: Schema.Attribute.Relation<'oneToOne', 'api::cliente.cliente'>;
    direccion: Schema.Attribute.Text;
    ciudad: Schema.Attribute.String;
    cod_postal: Schema.Attribute.String;
...
export interface ApiPedidoPedido extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    codigo_descuento: Schema.Attribute.String;
    importe_descuento: Schema.Attribute.Decimal &
      Schema.Attribute.Required &
      Schema.Attribute.DefaultTo<0>;
    importe_transporte: Schema.Attribute.Decimal &
      Schema.Attribute.Required &
      Schema.Attribute.DefaultTo<0>;
    importe_productos: Schema.Attribute.Decimal &
      Schema.Attribute.Required &
      Schema.Attribute.DefaultTo<0>;
    importe_complementos: Schema.Attribute.Decimal &
      Schema.Attribute.Required &
      Schema.Attribute.DefaultTo<0>;
    importe_impuestos: Schema.Attribute.Decimal &
      Schema.Attribute.Required &
      Schema.Attribute.DefaultTo<0>;
    createdAt: Schema.Attribute.DateTime;
    updatedAt: Schema.Attribute.DateTime;
...
export interface ApiPostPost extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    post_content: Schema.Attribute.Text;
    post_author: Schema.Attribute.BigInteger & Schema.Attribute.DefaultTo<'0'>;
    post_date: Schema.Attribute.DateTime;
    post_title: Schema.Attribute.String;
    post_status: Schema.Attribute.String &
      Schema.Attribute.DefaultTo<'publish'>;
    post_name: Schema.Attribute.String & Schema.Attribute.DefaultTo<'"'>;
    last_modification: Schema.Attribute.DateTime;
    post_date_gmt: Schema.Attribute.DateTime;
    post_excerpt: Schema.Attribute.String;
    comment_status: Schema.Attribute.String &
      Schema.Attribute.DefaultTo<'open'>;
    ping_status: Schema.Attribute.String & Schema.Attribute.DefaultTo<'open'>;
    post_password: Schema.Attribute.String & Schema.Attribute.DefaultTo<'"'>;
    to_ping: Schema.Attribute.String;
    pinged: Schema.Attribute.String;
    post_modified: Schema.Attribute.DateTime;
    post_content_filtered: Schema.Attribute.Text;
    post_parent: Schema.Attribute.BigInteger & Schema.Attribute.DefaultTo<'0'>;
    guid: Schema.Attribute.String;
    menu_order: Schema.Attribute.Integer & Schema.Attribute.DefaultTo<0>;
    post_type: Schema.Attribute.String & Schema.Attribute.DefaultTo<'post'>;
    post_mime_type: Schema.Attribute.String & Schema.Attribute.DefaultTo<'"'>;
    comment_count: Schema.Attribute.BigInteger &
      Schema.Attribute.DefaultTo<'0'>;
    post_modified_gmt: Schema.Attribute.DateTime;
    post_id: Schema.Attribute.BigInteger;
    ...
    etiquetas_posts: Schema.Attribute.Relation<
      ...
      'api::etiqueta-post.etiqueta-post'
    >;
    publicacion_automatica: Schema.Attribute.Boolean &
      Schema.Attribute.Required &
